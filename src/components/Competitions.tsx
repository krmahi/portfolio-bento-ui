      ...
      <div className="compi-blocks">
        ...
        <div className="block-1 yellow cerit-block-span">
          ...
          <div className="achi-content">
            <div className="achi-sub-content compi-div">
              <span>qualified in top 20 against a total of 60,243</span>
            </div>
          </div>
        </div>
        {/* 2nd */}
        <div className="block-1 orange cerit-block-span">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>cleared quiz and coding round</span>
            </div>
          </div>
        </div>
        {/* 3rd */}
        <div className="block-1 green cerit-block-span">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>advanced level 2 | interview call-up from flipkart</span>
            </div>
          </div>
        </div>
        {/* 4th */}
        <div className="block-1 grey cerit-block-span">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>computer vision Data Science challenge</span>
            </div>
          </div>
        </div>
        {/* 5th */}
        ...
        <div className="block-1 yellow">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>prototype submission</span>
            </div>
          </div>
        </div>
        {/* 7th */}
        ...
        <div className="block-1 blue">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>algorithmic coding challenge</span>
            </div>
          </div>
        </div>
        {/* 9th */}
        <div className="block-1 purple">
          ...
          <div className="achi-content">
            <div className="achi-sub-content">
              <span>case study challenge</span>
            </div>
          </div>
        </div>
        {/* 10th */}
